...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle nl;
    ros::Publisher pub = nl.advertise<yoloDarknetRosNode::BoundingBoxArray>("numberInterface",1000);
    ros::Rate rate(10);  //rate is object of class ROS.
    
    while (ros::ok())
    {
        yoloDarknetRosNode::BoundingBox data ;
        ...
        data.xmin = 10;
        data.ymax = 10;
        yoloDarknetRosNode::BoundingBoxArray msg;
