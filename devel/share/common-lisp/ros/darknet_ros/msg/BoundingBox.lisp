...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name darknet_ros-msg:<BoundingBox> is deprecated: use darknet_ros-msg:BoundingBox instead.")))
...
(cl:defmethod probability-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader darknet_ros-msg:probability-val is deprecated.  Use darknet_ros-msg:probability instead.")
  (probability m))
